...
declare module Blockly.Events {
    ...
    class BlockBase__Class extends Blockly.Events.Abstract__Class {
         ...
         * @param {Blockly.Bloce {string}
         */
        blockId: string;

        /**
         * Encode the event as JSON.
         * @return {!Object} JSON* @typ
         k} block The block this event corresponds to.
    ...
    class Change__Class extends Blockly.Events.BlockBase__Class {
         ...
         * @param {Blockly.Block}         type: string;
...
class Create__Class extends Blockly.Events.BlockBase__Class {
     ...
     * @param {Blockly.Bloc         type: string;
...
declare module Blockly {
    ...
    class BlockSvg__Class extends Blockly.Block__Class {
        ...
        /**
         Render* Height of this block, not including any statement blocks above       ow.
         ...
         * Width of this block, including any connected value blocks.
         or bel   * Width is in workspace units.
         */
        width: any /*missing*/;

        /**
         * An optional method called when a mutator dialog is first opened               * This function must create and initialize a top-level block for the mutator
        ...
        /**
         * An optional method called when a mutator dialog saves its conte.
         ...
         * Returns a list of mutator, comment, and warning icons.
         ...
         alled directly, workspace.newBlock() is preferred.
...
tab(start
:
Blockly.Field | Blockly.Block, forward
:
boolean
):
void;
 ...
 */
dispose(healStack ? : boolean, animate ? : boolean)
:
void;
 ...
 *     list of statement types.  Null/undefined if any type could be connected.
 */
setPreviousStatement(newBoolean
:
boolean, opt_check ? : string | string[] | any /*null*/
):
void;
 ...
 * @param {number} refIndex Index of input that should be after the moved input.
 */
moveNumberedInputBefore(inputIndex
:
number, refIndex
:
number
 ...
 */
positionNearConnection(sourceConnection
:
 ...
 * @package
 */
positionNewBlock(newBlock
:
Blockly.Block, newConnection
:
Blockly.Connection, existingConnection
:
Blockly.Connection
):
void;
...
declare module Blockly {
    ...
    class Bubble__Class {
         ...
         * ction}
         rkspace The workspace on which to draw the
         *     bubble.
         ...
         * @type {Fun@retur
n {SVGElement} The root SVG node of the bubble's group.
         */
...
declare module Blockly {
    ...
    class Connection__Class {
         ...
         * @param {!Blockl        sourceBlock_: Blockly.Block;
        ...
        /**
         /
         ection this connection connects to.  Null if not connected.* Conn        * @type {Blockly.Connection}
         */
         ...
         * @type {numumber}            * @protected
         */
        y_: number;

        /**
         * Connect two connections together.  This is the connection on thber}

         y.Block} source The block establishing this connection.
...
declare module Blockly.Events {
    ...
    class Abstract__Class {
        ...
        /**
         * The event group id for the group this event belongs to. Groups string
...
declare module Blockly {
    ...
    class Field__Class {
         ...
         * @param {*} valuely be non-null, only null when the field is created.
         * @type {*}
         * @protected
         */
        value_: any;
         ...
         * Statice {!Bls are usually unnamed.
         * @type {string|undefined}
         */
        ...
        /**
         * Block this field is attached to.  Starts as null, then set in i.
         * @type {Blockly.Block}
         * @protected
         */
        ...
        /**
         * Is the field visible, or hidden due to the block being collapseoolean          * @type {boolean}
         * @protected
         */
        visible_: boolean;
        ...
        /**
         * Serializable fields are saved by the XML renderer, non-serializ      ields
        ...
        /**
         * Editable fields usually show some sort of UI indicating they ar * @pa
         ram {!Object} config A map of options used to configure the field. See
         *    the individual field's documentation for a list of properties this
         *    parameter supports.
         * @protected
         */
...
declare module Blockly {
    ...
    class FieldAngle__Class extends Blockly.FieldTextInput__Class {
         ...
         * @package
         able f
         er=} opt_value The initial value of the field. Should cast
        ...
        /**
         * Serializable fields are saved by the XML renderer, non-serializ
         */
        initView(): void;
...
declare module Blockly {
    ...
    class FieldCheckbox__Class extends Blockly.Field__Class {
        ...
        /**
         * Mouse cursor style when over the hotspot that initiates editabiable f             */
        CURSOR: any /*missing*/;

        /**
         * Used to tell if the field needs to be rendered the next time thlity.
         k is
         ...
         * @package
         e bloc
         pt_value The initial value of the field. Should
...
declare module Blockly {
    ...
    class FieldColour__Class extends Blockly.Field__Class {
        ...
        /**
         * Mouse cursor style when over the hotspot that initiates the ediable f            */
        CURSOR: any /*missing*/;

        /**
         * Used to tell if the field needs to be rendered the next time thtor.
         k is
         ...
         * @packe bloc
         alue The initial value of the field. Should be in
        ...
        /**
         * Serializable fields are saved by the XML renderer, non-serializage
...
declare module Blockly {
    ...
    class FieldDate__Class extends Blockly.Field__Class {
         ...
         * @pator.
         ...
         ue The initial value of the field. Should be in
        ...
        /**
         * Serializable fields are saved by the XML renderer, non-serializram {*
=} opt_newValue The input value.
...
declare module Blockly {
    ...
    class FieldDropdown__Class extends Blockly.Field__Class {
         ...
         * @param {(!Array. which generates these options.
         * @type {(!Array.<!Array>|
        ...
        /**
         * Serializable fields are saved by the XML renderer, non-serializnctionields
         * are not. Editable fields should also be serializable.
         * @type {boolean}
         */
        SERIALIZABLE: boolean;
         ...
         * @package
         ...
         <!Array>|!Function)} menuGenerator A non-empty array of
...
declare module Blockly {
    ...
    class FieldImage__Class extends Blockly.Field__Class {
         ...
         * @param {string} src The         * editable. This field should not.
         * @type {boolean}
         */
        EDITABLE: boolean;

        /**
         * Used to tell if the field needs to be rendered the next time the
         k is
        ...
        /**
         * Editable fields usually show some sort of UI indicating they ar
         */
        initView(): void;
...
declare module Blockly {
    ...
    class FieldLabelSerializable__Class extends Blockly.FieldLabel__Class {
         ...
         * @pa         * editable. This field should not.
         * @type {boolean}
         */
        EDITABLE: boolean;

        /**
         * Serializable fields are saved by the XML renderer, non-serialize
         ields
...
declare module Blockly.FieldLabelSerializable {
    ...
    /**
     * Construct a FieldLabable f
     ram {*} opt_value The initial value of the field. Should cast to a
     *    string. Defaults to an empty string if null or undefined.
     * @param {string=} opt_class Optional CSS class for the field's text.
     * @param {Object=} opt_config A map of options used to configure the field.
...
:
    any, opt_class ? : string, opt_config ? : Object
)
    ;

    /**
     * Editable fields usually show some sort of UI indicating they arelSerializable from a JSON arg object,
     * dereferencing any string table references.
     * @param {!Object} options A JSON object with options (text, and class).
...
declare module Blockly {
    ...
    class FieldNumber__Class extends Blockly.FieldTextInput__Class {
        ...
        /**
         * Serializable fields are saved by the XML renderer, non-serializ  * @tields
         * are not. Editable fields should also be serializable.
         * @type {boolean}
         */
        SERIALIZABLE: boolean;
        ...
        /**
         * Set the maximum, minimum and precision constraints on this fielable f
         ber=} opt_value The initial value of the field. Should cast
         *    to a number. Defaults to 0.
...
declare module Blockly {
    ...
    class FieldTextInput__Class extends Blockly.Field__Class {
        ...
        /**
         * Serializable fields are saved by the XML renderer, non-serializooleanields
         * are not. Editable fields should also be serializable.
         * @type {boolean}
         */
        SERIALIZABLE: boolean;
         ...
         * Ensure that the input value casts to a valid string.
         ...
         _value The initial value of the field. Should cast to a
         *    string. Defaults to an empty string if null or undefined.
         * @param {Function=} opt_validator A function that is called to validate
...
declare module Blockly {
    ...
    class FieldVariable__Class extends Blockly.FieldDropdown__Class {
         ...
         * @param {?string which generates these options.
        ...
        /**
         * The initial variable name passed to this field's constructor, onction            * empty string if a name wasn't provided. Used to create the initial
         * variable.
         * @type {string}
         */
        ...
        /**
         * Serializable fields are saved by the XML renderer, non-serializr an
         ields
         * are not. Editable fields should also be serializable.
         * @type {boolean}
         */
         ...
         * Configure the field based on the given map of options.
         able f
         } varName The default name for the variable.  If null,
...
declare module Blockly {
    ...
    class Flyout__Class {
        ...
        /**
         * Gap between items in horizontal flyouts. Can be overridden with   * @sep"
         * element.
         * @const {number}
         */
        GAP_X: any /*missing*/;
        ...
        /**
         * Gap between items in vertical flyouts. Can be overridden with t the "p"
         * element.
         * @const {number}
         */
        GAP_Y: any /*missing*/;
        ...
        /**
         * Top/bottom padding between scrollbar and edge of flyout backgrohe "se            * @type {number}
         * @const
         */
        ...
        /**
         * Range of a drag angle from a flyout considered "dragging toward@protepace".
        ...
        /**
         * Creates the flyout's DOM.  Only needs to be called once.  The f works
...
declare module Blockly {
    ...
    class FlyoutButton__Class {
         ...
         * @return {!SVGElement
kspaceSvg} workspace The workspace in which to place this
         *     button.
...
declare module Blockly {
    ...
    class Generator__Class {
        ...
        /**
         * Class for a code generator that translates the blocks into a languageops.
         ...
         *ite lonstances of '%1' will be replaced by the block ID of the statement.
         * E.g. 'highlight(%1);\n'
         * @type {?string}
         */
         ...
         *  Any istances of '%1' will be replaced by the block ID of the statement.
         * E.g. 'highlight(%1);\n'
         * @type {?string}
         */
        ...
        /**
         * The method of indenting.  Defaults to two spaces, but language Any intors
        ...
        /**
         * Maximum length for a comment before wrapping.  Does not accountgenera            * indenting level.
         * @type {number}
         */
        COMMENT_WRAP: number;
        ...
        /**
         * Generate code for all blocks in the workspace to the specified
         .
        ...
        /**
         * Arbitrary code to inject into locations that risk causing infinlangua
         ge.
...
declare module Blockly {
    ...
    class Gesture__Class {
         ...
         * @param {!Event} e The event thaxels,
        ...
        /**
         * The workspace that the gesture started on.  There may be multipCSS pi          * workspaces on a page; this is more accurate than using
        ...
        /**
         * A handle to use to unbind a mouse move listener at the end of ale
        ...
        /**
         * A handle to use to unbind a mouse up listener at the end of a d drag.            * Opaque data returned from Blockly.bindEventWithChecks_.
         * @type {Array.<!Array>}
         * @protected
         */
        onUpWrapper_: any[][];
        ...
        /**
         * The position of the mouse when the gesture started.  Units are
         */
        dispose(): void;
...
declare module Blockly {
    ...
    class Icon__Class {
        ...
        /**
         * Class for an icon.
         * @param {Blockly.BlockSvg} block TheckSvg}
         * @protected
         */
...
*/
    ...
    y.Conn       /** @type {!Array.<!Blockly.Field>} */
...
:
     ...
     * @return {Bl   * @
ber} type The type of the input.
     * @param {string} name Language-neutral identifier which may used to find this
     *     input again.
...
:
    ...
    /** @type {stringockly.
Block} The source block, or null if there is none.
     */
    getSourceBlock()
:
    Blockly.Block;
    ...
    appendField(field
:
    string | Blockly.Field, opt_name ? : string
):
    Blockly.Input;
...
:
    ...
    /**
     @retur
     n {Object} Contains size and position metrics, or null.
     */
    getMetrics()
:
    Object;
...
declare module Blockly {
    ...
    class Scrollbar__Class {
         ...
         * This technique offers a scrollbar that i  * the most recent drag.
         ...
         * Unlink from all DOM elements to prevent
         s guaranteed to work, but may not
...
declare module Blockly {
    ...
    class Theme__Class {
        ...
        /**
         * Class for a theme.
         * @param {!Object.<string, Blockly.Theme.BlockStyle>} b
         */
        blockStyles_: { [key: string]: Blockly.Theme.BlockStyle };

        /**
         * The category styles map.
         * @type {!Object.<string, Blockly.Theme.Cattyle>}tyle>}
         */
         ...
         * @type {!Object.<string, Blockly.Theme.BlockSam {Ob
ject.<string, Blockly.Theme.BlockStyle>} blockStyles Map of
         *     block styles.
         */
...
declare module Blockly {
    ...
    class Toolbox__Class {
         ...
         * @param {!Node} langua   /**
         Blockly.WorkspaceSvg} workspace The workspace in which to create new
         *     blocks.
         * @constructor
         */
...
:
     ...
     */
    setColourFromStyle_(styleName
:
    string, childOut
:
    Blockly.tree.TreeNode, categoryName
:
    string
):
    void;
...
declare module Blockly {
    ...
    class Trashcan__Class {
         ...
         * @param {!Blockly.Workspace} workspace The workspa         isOpen: boolean;

         /**
         * Create the trash can elements.
         * @return {!SVGElement} The trash can*/
...
declare module Blockly.Events {
    ...
    class Ui__Class extends Blockly.Events.Abstract__Class {
         ...
         * UI events are events that don't need to be sent oving;

         /**
         * Encode the event as JSON.
         * @return {!Object} JSON representation.
         e: str
         er the wire for multi-user
...
declare module Blockly.Events {
    ...
    class VarBase__Class extends Blockly.Events.Abstract__Class {
         ...
         * @param {Blockly.VariableModel} vari             */
        varId: string;
         ...
         * @return {!Object} JSON representation.
         ...
         able The variable this event corresponds
         *     to.
         * @extends {Blockly.Events.Abstract}
         * @constructor
         */
    ...
    class VarCreate__Class extends Blockly.Events.VarBase__Class {
         ...
         * @param {Blockly.VariableModel} variing;

         /**
         * Encode the event as JSON.
         * @return {!Object} JSON representation.
         e: str
         able The created variable.
    ...
    */
    ...
    class VarRename__Class extends Blockly.Events.VarBase__Class {
         ...
         * @param {Blockly.VariableModel} variabing;

         /**
         * Encode the event as JSON.
         * @return {!Object} JSON representation.
         e: str
         le The renamed variable.
         *     Null for a blank event.
...
:
    ...
    createVariable(name
:
    string, opt_type ? : string, opt_id ? : string
):
...
declare module Blockly {
    ...
    class VariableModel__Class {
         ...
         * Holds information for the variable including  */
        workspace: Blockly.Workspace;

        /**
         * The name of the variable, typically defined by the user. It must be
         ue across all names used for procedures and variables. It may be
         * changed by the user.
         * @type {string}
         */
        name: string;
         ...
         * uniqsed to build a list of variables of a specific type. By default this is
...
declare module Blockly {
    ...
    class Warning__Class extends Blockly.Icon__Class {
        ...
        /**
         * Class for a warning.
         * @param {!Blockly.Block} block The block associated apseHidden: any /*missing*/
    ;

        /**
         * Show or hide the warning bubble.
         * @param {boolean} visible True if   coll
         with this warning.
         * @extends {Blockly.Icon}
         * @constructor
         */
...
declare module Blockly {
    ...
    /**
     * @type
        ay.<!Blockly.Events.Abstract>}
     * @protected
     {!Arr         undoStack_: Blockly.Events.Abstract[];
...
*/
     ...
     * @param {Blockly.Cursor} cArray.
     here is no UI, and can be created headlessly.
...
declare module Blockly {
    ...
    class WorkspaceComment__Class {
         ...
         * @param {!Blockly.Workspace} workspace Then workspace units.  (0, 0) is at the workspace's
         tion i origin; scale does not change this value.
         * @type {!Blockly.utils.Coordinate}
         * @protected
         */
    ...
    * /
    constructor(workspace
:
    Blockly.Workspace, content
:
    string, height
:
    number, width
:
    number, opt_id ? : string
)
    ;
...
declare module Blockly {
    ...
    class WorkspaceDragSurfaceSvg__Class {
         ...
         * The* progress, the SVG is empty and display: none.
...
:
     ...
     * @package
     */
    setContentsAndShow(blockCanvas
:
    SVGElement, bubbleCanvas
:
...
declare module Blockly.Events {
    ...
    class FinishedLoading__Class extends Blockly.Events.Abstract__Class {
         ...
         * Used to notify the developer when th            workspaceId: string;
...
*/
     ...
     * @return {!Object} JSON representation.
     e: str
     e workspace has finished loading (i.e
     * domToWorkspace).
...
declare module Blockly {
    ...
    class WorkspaceSvg__Class extends Blockly.Workspace__Class {
         ...
         * Returns `false` for headles the rspaces and true for instances of
        ...
        /**
         umber;* This workspace's scrollbars, if they exist.
         * @type {Blockly.Scrollb      }
         */
        scrollbar: Blockly.ScrollbarPair;

        /**
         * Developers may define this function to add custom menu options to the
         arPair    * Otherwise null.
         * @type {Blockly.WorkspaceSvg}
         * @package
         */
         ...
         * @return {!Block  * wot="100%" width="100%"></rect>
        ...
        /**
         t} curspose of this workspace.
         * Unlink from all DOM elements to preventt} mar             * Getter for the flyout associated with this workspace.  This flyout may be
         to us
         ...
         * You can passreenCT
         rkspace's context menu or edit the workspace-created set of menu options.
         ...
         * In a flyout, the target workspace where blocks should be placed after a drag.
         sible.
         ckRendering.Renderer} The renderer attached to this workspace.
         */
         ...
         * @param {SVGElemen
sorSvg The svg root of the cursor to be added to the
         *     workspace svg group.
         * @package
         */
        setCursorSvg(cursorSvg: SVGElement): void;
         ...
         * @param {SVGElemen the D
kerSvg The svg root of the marker to be added to the
         *     workspace svg group.
         * @package
         */
        setMarkerSvg(markerSvg: SVGElement): void;
         ...
         * @return {SVGMatrix} The matrixram {!
e in mouseToSvg
         */
         ...
         */
        updateInverseScClass

        M(): void;

        /**
         * Getter for isVisible
         * @return {boolean} Whether the workspace is vi heigh
         ...
         * Walksement}
         OM the first time it's called, then returns a cached value.
         ...
         * @pa  * Di
         Array.<!Array>} handler Data that can be passed to unbindEvent_.
         */
        setResizeHandlerWrapper(handler: any[][]): void;

        /**
         * Create the workspace DOM elements.
         * @param {string=} opt_background memor
         ...
         *   <rect class="blocklyMainBackground": void
         y leaks.
         */
        dispose(): void;
...
:
     ...
     */
    registerToolboxCategoryCallback(key
:
    string, func
:
    {
...
declare module Blockly.Events {
    ...
    class CommentBase__Class extends Blockly.Events.Abstract__Class {
         ...
         * @param {Blockly.WorkspaceComment} co  */
        commentId: string;
...
*/
     ...
     * @return {!Object} JSON representation.
     oolean
     mment The comment this event corresponds
     *     to.
     * @extends {Blockly.Events.Abstract}
     * @constructor
     */
...
class CommentChange__Class extends Blockly.Events.CommentBase__Class {
     ...
     * @param {Blockly.WorkspaceComment} comming;

     /**
     * Encode the event as JSON.
     * @return {!Object} JSON representation.
     e: str
     ent The comment that is being changed.
     *     Null for a blank event.
...
class CommentCreate__Class extends Blockly.Events.CommentBase__Class {
     ...
     * @param {Blockly.WorkspaceComment} coing;

     /**
     * Encode the event as JSON.
     * @return {!Object} JSON representation.
     e: str
     mment The created comment.
     *     Null for a blank event.
     * @extends {Blockly.Events.CommentBase}
     * @constructor
     */
...
class CommentMove__Class extends Blockly.Events.CommentBase__Class {
     ...
     * @type {!Bl      utils.Coordinate}
     */
    oldCoordinate_: Blockly.utils.Coordinate;

    /**
     * The location after the move, in workspace coordinates.
     * @type {Blocockly.ils.Coordinate}
     */
     ...
     *
     y.WorkspaceComment} comment The comment that is being moved.
     *     Null for a blank event.
     * @extends {Blockly.Events.CommentBase}
     * @constructor
     */
...
declare module Blockly {
    ...
    class CursorSvg__Class {
        ...
        /**
         * Class for a cursor.
         * @param {!Blockly.WorkspaceSvg} workspace The workspa            currentCursorSvg: Element;
    ...
    * /
    constructor(workspace
:
    Blockly.WorkspaceSvg, opt_marker ? : boolean
)
    ;
...
declare module Blockly.utils {
    ...
    class Rect__Class {
        ...
        /**
         {numbe* Tests whether this rectangle contains a x/y coordinate.
         *
         * @param {number} x The x coordinate to
...
declare module Blockly.tree {
    ...
    class BaseNode__Class extends Blockly.Component__Class {
        ...
        /*
am {string} content The content of the node label treated as
...
*/
     ...
     */
    JAGGEether
    H_HEIGHT: any /*missing*/;

    /**
     * Width of SVG path for jagged teeth at the end of collapsed blocks.
     * @const
     */
    JAGGEDD_TEET_WIDTH: any /*missing*/;
 ...
 * @type {!Object}
 */
NOTCH:ZZLE_TAB: Object;

/**
 * An object containing sizing and path information about inside corners
 * @type {!Object}
 */
STARINSIDE_CORNERS: Object;
...
declare module Blockly.blockRendering {
    ...
    class Drawer__Class {
         ...
         * elements and moving fields, icons, an
...
declare module Blockly.blockRendering {
    ...
    class RenderInfo__Class {
         ...
         *
         * This measure pass does not p        renderer_: Blockly.blockRendering.Renderer;
         ...
         * Otherwise null.
         * @type {
     y.blockRendering.OutputConnection}
         */
         ...
         * inline or because it has been colBlockl.
         * @type {boolean}
         */
        isInline: boolean;
    ...
    .
         ...
         * shape as normal blocks, but don't           * @type {boolean}
         */
        isInsertionMarker: boolean;
         ...
         * edge of the block when rendered hChild            * @type {number}
         */
        width: number;
        ...
        /**
         * An arrLTR.
         Row objects containing sizing information.
         ...
         * @type {!Blockly.blockRendering.Botto                   */
         ...
         * @return {!Blockly.blockRendering.Renderer} The block renderer in use.
         ...
         ropagate changes to the block (although fields
...
:
     ...
     * @protected
     */
    constants_: Blockly.blockRendass
extends
    Blockly.blockRendering.Measurable__Class
    {
        ...
        constructor(constants
    :
        Blockly.blockRendering.ConstantProvider, connectionModel
    :
        Blockly.RenderedConnection
    )
        ;
...
declare module Blockly.blockRendering {
    ...
    class Row__Class {
         ...
         * subcomponents.
         * @param {!Blockly.blockRendering.ConstantProvider} constants The renderi contained in this row.
         * @package
         * @type {!Array.<!Blockly.blockRendering.Measurable>}
         */
        elements: Blockly.ementsendering.Measurable[];
        ...
        /**
         * The width of the row, frblockR left edge of the block to the right.
        ...
        /**
         * The minimum w {numbf the row, from the left edge of the block to the right.
         * Does not include child blocks unless they are inline.
         * @package
         idth ope {number}
         */
...
*/
    ...
    /**
     e row has any statement inputs.
     * @package
     * @type {boolean}
     */
    ...
    /**
     * ther the row has any inline inputs.
     * @package
     * @type {boolean}
     */
    ...
    /**
     * Wheher the row has any dummy inputs.
     * @package
     * @type {boolean}
     */
    ...
    /**
     * * Whetr the row has a jagged edge.
     * @package
     * @type {boolean}
     */
    ...
    /**
     * TheWhetherer's constant provider.
     * @type {!Blockly.blockRendering.ConstantProvider}
     * @protected
     */
    constants_: Blockly.blockRend
    rendeConstantProvider;
...
:
    ...
    /**
     * An array of elhe las
     t input on this row, if it has one.
...
class TopRow__Class extends Blockly.blockRendering.Row__Class {
     ...
     * Elements in a top row can consist of corners, hats, space @package
     * @type {number}
     */
    capline: number;
    ...
    /**
     * The previous co      on on the block, if any.
...
class BottomRow__Class extends Blockly.blockRendering.Row__Class {
     ...
     * Elements in a bottom row can consist of corners, spac, if any.
     * @package
     ...
     * @returns {boolean} Whether or not the bo
     ers and next
     * connections.
     * @param {!Blockly.blockRendering.ConstantProvider} constants The rendering
     *   constants provider.
    ...
    /**
     * The next connection on tttom r
     ow has a left square corner.
     */
...
class InputRow__Class extends Blockly.blockRendering.Row__Class {
     ...
     *   constants provider.
     * @package
     d populate all size properties on the row.
     * @package
     */
    measure(): void;
}
