...
Blockly.Dart.scrub_ = function (a, b, c) {
    ...
    if (!a.outputConnection || !a.outputConnection.targetConnection) {
        ...
        e && (e = Blockly.utils.string.wrap(e, Blockly.Dart.COMMENT_WRAP - 3), d = a.getProcedureDef ? d + Blockly.Dart.prefixLines(e + "\n", "/// ") : d + Blockly.Dart.prefixLines(e + "\n", "// "));
...
"  int getAt(String where, num at) {","    if (where == 'FROM_END') {","      at = list.length - 1 - at;","    } else if (where == 'FIRST') {","      at = 0;","    } else if (where == 'LAST') {","      at = list.length - 1;","    } else if (where != 'FROM_START') {","      throw 'Unhandled option (lists_getSublist).';","    }","    return at;","  }","  at1 = getAt(where1, at1);","  at2 = getAt(where2, at2) + 1;","  return list.sublist(at1, at2);","}"])+"("+b+", '"+c+"', "+e+", '"+d+"', "+f+")";return[a,
...
Blockly.Dart.controls_if = function (a) {
    ...
    if (a.getInput("ELSE") || Blockly.Dart.STATEMENT_SUFFIX) e =
        Blockly.Dart.statementToCode(a, "ELSE"), Blockly.Dart.STATEMENT_SUFFIX && (e = Blockly.Dart.prefixLines(Blockly.Dart.injectId(Blockly.Dart.STATEMENT_SUFFIX, a), Blockly.Dart.INDENT) + e), c += " else {\n" + e + "}";
    return c + "\n"
};
...
Blockly.Dart.math_atan2=function(a){Blockly.Dart.definitions_.import_dart_math="import 'dart:math' as Math;";var b=Blockly.Dart.valueToCode(a,"X",Blockly.Dart.ORDER_NONE)||"0";return["Math.atan2("+(Blockly.Dart.valueToCode(a,"Y",Blockly.Dart.ORDER_NONE)||"0")+", "+b+") / Math.pi * 180",Blockly.Dart.ORDER_MULTIPLICATIVE]};Blockly.Dart.procedures={};
Blockly.Dart.procedures_defreturn = function (a) {
    var b = Blockly.Dart.variableDB_.getName(a.getFieldValue("NAME"), Blockly.Procedures.NAME_TYPE), c = "";
    Blockly.Dart.STATEMENT_PREFIX && (c += Blockly.Dart.injectId(Blockly.Dart.STATEMENT_PREFIX, a));
    ...
    var d = "";
    Blockly.Dart.INFINITE_LOOP_TRAP && (d = Blockly.Dart.prefixLines(Blockly.Dart.injectId(Blockly.Dart.INFINITE_LOOP_TRAP, a),
        Blockly.Dart.INDENT));
    var e = Blockly.Dart.statementToCode(a, "STACK"),
        f = Blockly.Dart.valueToCode(a, "RETURN", Blockly.Dart.ORDER_NONE) || "", g = "";
    e && f && (g = c);
...
Blockly.Dart.text_multiline = function (a) {
    return [Blockly.Dart.multiline_quote_(a.getFieldValue("TEXT")), Blockly.Dart.ORDER_ATOMIC]
};
