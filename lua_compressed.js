...
Blockly.Lua.scrub_ = function (a, b, c) {
    ...
    if (!a.outputConnection || !a.outputConnection.targetConnection) {
        ...
        e && (e = Blockly.utils.string.wrap(e, Blockly.Lua.COMMENT_WRAP - 3), d += Blockly.Lua.prefixLines(e, "-- ") + "\n");
...
Blockly.Lua.controls_if = function (a) {
    ...
    if (a.getInput("ELSE") || Blockly.Lua.STATEMENT_SUFFIX) e =
        Blockly.Lua.statementToCode(a, "ELSE"), Blockly.Lua.STATEMENT_SUFFIX && (e = Blockly.Lua.prefixLines(Blockly.Lua.injectId(Blockly.Lua.STATEMENT_SUFFIX, a), Blockly.Lua.INDENT) + e), c += "else\n" + e;
    return c + "end\n"
};
...
Blockly.Lua.controls_for = function (a) {
    var b = Blockly.Lua.variableDB_.getName(a.getFieldValue("VAR"), Blockly.Variables.NAME_TYPE),
        ...
        e = Blockly.Lua.valueToCode(a, "BY", Blockly.Lua.ORDER_NONE) || "1", f = Blockly.Lua.statementToCode(a, "DO");
    f = Blockly.Lua.addLoopTrap(f, a);
    f = Blockly.Lua.addContinueLabel_(f);
    a = "";
    if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e)) var g = (Number(c) <=
    Number(d) ? "" : "-") + Math.abs(Number(e)); else a = "", g = Blockly.Lua.variableDB_.getDistinctName(b + "_inc", Blockly.Variables.NAME_TYPE), a += g + " = ", a = Blockly.isNumber(e) ? a + (Math.abs(e) + "\n") : a + ("math.abs(" + e + ")\n"), a = a + ("if (" + c + ") > (" + d + ") then\n") + (Blockly.Lua.INDENT + g + " = -" + g + "\n"), a += "end\n";
...
Blockly.Lua.controls_flow_statements = function (a) {
    ...
    switch (a.getFieldValue("FLOW")) {
        ...
        case "CONTINUE":
            return b +
                Blockly.Lua.CONTINUE_STATEMENT
    }
...
Blockly.Lua.math_atan2=function(a){var b=Blockly.Lua.valueToCode(a,"X",Blockly.Lua.ORDER_NONE)||"0";return["math.deg(math.atan2("+(Blockly.Lua.valueToCode(a,"Y",Blockly.Lua.ORDER_NONE)||"0")+", "+b+"))",Blockly.Lua.ORDER_HIGH]};Blockly.Lua.procedures={};
Blockly.Lua.procedures_defreturn = function (a) {
    var b = Blockly.Lua.variableDB_.getName(a.getFieldValue("NAME"), Blockly.Procedures.NAME_TYPE), c = "";
    Blockly.Lua.STATEMENT_PREFIX && (c += Blockly.Lua.injectId(Blockly.Lua.STATEMENT_PREFIX, a));
    ...
    var e = Blockly.Lua.statementToCode(a, "STACK"),
        f = Blockly.Lua.valueToCode(a, "RETURN", Blockly.Lua.ORDER_NONE) || "", g = "";
    e && f && (g = c);
...
Blockly.Lua.text_multiline = function (a) {
    return [Blockly.Lua.multiline_quote_(a.getFieldValue("TEXT")), Blockly.Lua.ORDER_ATOMIC]
};
