...
Blockly.utils.screenToWsCoordinates = function (a, b) {
    var c = b.x, d = b.y, e = a.getInjectionDiv().getBoundingClientRect();
        ...
        for (var h = 0; h < e; h++) {
            ...
            if ("block" == l || "shadow" == l && !Blockly.Events.recordUndo) {
                ...
                if ("comment" == l) b.rendered ? Blockly.WorkspaceCommentSvg ? Blockly.WorkspaceCommentSvg.fromXml(k, b, d) : console.warn("Missing require for Blockly.WorkspaceCommentSvg, ignoring workspace comment.") : Blockly.WorkspaceComment ?
                    Blockly.WorkspaceComment.fromXml(k, b) : console.warn("Missing require for Blockly.WorkspaceComment, ignoring workspace comment."); else if ("variables" == l) {
...
Blockly.Xml.domToVariables = function (a, b) {
    for (var c = 0, d; d = a.childNodes[c]; c++) if (d.nodeType == Blockly.utils.dom.Node.ELEMENT_NODE) {
...
Blockly.Xml.domToBlockHeadless_ = function (a, b) {
    ...
    var f = null;
    e = 0;
    for (var g; g = a.childNodes[e]; e++) if (g.nodeType != Blockly.utils.dom.Node.TEXT_NODE) {
...
Blockly.InsertionMarkerManager.prototype.createMarkerBlock_ = function (a) {
    ...
    try {
        ...
        for (b = 0; b < a.inputList.length; b++) {
            var e = a.inputList[b], f = c.inputList[b];
...
Blockly.BlockDragger.prototype.dragBlock = function (a, b) {
    var c = this.pixelsToWorkspaceUnits_(b), d = Blockly.utils.Coordinate.sum(this.startXY_, c);
...
Blockly.Scrollbar.prototype.createDom_ = function (a) {
    ...
    this.svgHandle_ = Blockly.utils.dom.createSvgElement("rect",
        {"class": "blocklyScrollbarHandle", rx: a, ry: a}, this.svgGroup_);
...
Blockly.ThemeManager.prototype.setTheme = function (a) {
    if (this.theme_ !== a) {
        ...
        for (var c; c = b[a]; a++) for (var d = 0, e; e = this.componentDB_[c][d]; d++) {
            var f = e.element;
            e = e.propertyName;
...
Blockly.Bubble.prototype.createDom_ = function (a, b) {
    ...
    this.bubbleBack_ = Blockly.utils.dom.createSvgElement("rect", {
        ...
        c);
    b ? (this.resizeGroup_ = Blockly.utils.dom.createSvgElement("g", {"class": this.workspace_.RTL ? "blocklyResizeSW" : "blocklyResizeSE"}, this.bubbleGroup_), c = 2 * Blockly.Bubble.BORDER_WIDTH, Blockly.utils.dom.createSvgElement("polygon", {points: "0,x x,x x,0".replace(/x/g, c.toString())}, this.resizeGroup_), Blockly.utils.dom.createSvgElement("line", {
        ...
        "class": "blocklyResizeLine", x1: 2 * c / 3, y1: c - 1, x2: c -
            1, y2: 2 * c / 3
...
Blockly.Block.prototype.unplugFromRow_ = function (a) {
    ...
    if (b && a && (a = this.getOnlyValueConnection_()) && a.isConnected() && !a.targetBlock().isShadow()) if (a = a.targetConnection, a.disconnect(), a.checkType_(b)) b.connect(a); else a.onFailedConnect(b)
};
...
Blockly.Block.prototype.toString = function (a, b) {
    var c = [], d = b || "?";
    if (this.collapsed_) c.push(this.getInput("_TEMP_COLLAPSED_INPUT").fieldRow[0].getText()); else for (var e = 0, f; f = this.inputList[e]; e++) {
...
Blockly.Menu.prototype.highlightHelper = function (a, b) {
    var c = 0 > b ? -1 : b, d = this.getChildCount();
    c = a.call(this, c, d);
    for (var e = 0; e <= d;) {
...
Blockly.Icon.prototype.createIcon = function () {
    this.iconGroup_ || (this.iconGroup_ = Blockly.utils.dom.createSvgElement("g", {"class": "blocklyIconGroup"}, null), this.block_.isInFlyout && Blockly.utils.dom.addClass(this.iconGroup_, "blocklyIconGroupReadonly"), this.drawIcon_(this.iconGroup_), this.block_.getSvgRoot().appendChild(this.iconGroup_), Blockly.bindEventWithChecks_(this.iconGroup_, "mouseup", this, this.iconClick_), this.updateEditable())
};
...
Blockly.BlockSvg.prototype.getBoundingRectangle = function () {
    var a = this.getRelativeToSurfaceXY(this), b = this.outputConnection ? Blockly.BlockSvg.TAB_WIDTH : 0,
        c = this.getHeightWidth(), d = a.y, e = a.y + c.height;
    if (this.RTL) {
        var f = a.x - (c.width - b);
        a = a.x + b
...
Blockly.BlockSvg.prototype.generateContextMenu = function () {
    ...
    if (!this.isInFlyout) {
        ...
        if (this.isMovable()) if (this.collapsed_) this.workspace.options.collapse && (c = {enabled: !0}, c.text = Blockly.Msg.EXPAND_BLOCK, c.callback =
            function () {
                a.setCollapsed(!1)
            }, b.push(c)); else {
            ...
            this.workspace.options.collapse && (c = {enabled: !0}, c.text = Blockly.Msg.COLLAPSE_BLOCK, c.callback = function () {
                a.setCollapsed(!0)
            }, b.push(c))
        }
...
Blockly.DropDownDiv.showPositionedByField = function (a, b, c) {
    var d = a.getSvgRoot().getBoundingClientRect(), e = d.left + d.width / 2, f = d.bottom;
    d = d.top;
    c && (d += c);
    c = a.getSourceBlock();
...
Blockly.DropDownDiv.getPositionTopOfPageMetrics = function (a, b, c) {
    ...
    return {initialX: a.divX, initialY: 0, finalX: a.divX, finalY: 0, arrowVisible: !1}
};
...
Blockly.DropDownDiv.repositionForWindowResize = function () {
    if (Blockly.DropDownDiv.owner_) {
        var a = Blockly.DropDownDiv.owner_.getSourceBlock(), b = a.workspace.scale,
...
Blockly.Options = function (a) {
    ...
    var t = void 0 === a.oneBasedIndex ? !0 : !!a.oneBasedIndex, u = a.theme,
        v = a.keyMap || Blockly.user.keyMap.createDefaultKeyMap(), w = a.renderer || "geras";
    this.RTL = m;
...
Blockly.WorkspaceSvg.prototype.pasteBlock_ = function (a) {
    Blockly.Events.disable();
    try {
        var b = Blockly.Xml.domToBlock(a, this), c = this.getMarker().getCurNode();
        ...
        if (!isNaN(d) && !isNaN(e)) {
            ...
            do {
                ...
                if (!a) {
                    ...
                    c = 0;
                    for (var l; l = k[c]; c++) if (l.closest(Blockly.SNAP_RADIUS, new Blockly.utils.Coordinate(d, e)).connection) {
                        a = !0;
                        break
                    }
                }
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function (a) {
    ...
    if (!this.options.readOnly && !this.isFlyout) {
        ...
        if (this.options.collapse) {
            for (var k = h = !1, l = 0; l < e.length; l++) for (var m = e[l]; m;) m.isCollapsed() ? h = !0 : k = !0, m = m.getNextBlock();
            var n = function (a) {
...
Blockly.createDom_ = function (a, b) {
    ...
    var c = Blockly.utils.dom.createSvgElement("svg", {
            ...
            version: "1.1",
            "class": "blocklySvg"
        }, a), d = Blockly.utils.dom.createSvgElement("defs", {}, c), e = String(Math.random()).substring(2),
...
Blockly.ASTNode.createWorkspaceNode = function (a, b) {
    return new Blockly.ASTNode(Blockly.ASTNode.types.WORKSPACE, a, {wsCoordinate: b})
};
...
Blockly.ASTNode.prototype.findPreviousEditableField_ = function (a, b, c) {
    b = b.fieldRow;
    a = b.indexOf(a);
    for (c = (c ? b.length : a) - 1; a = b[c]; c--) if (a.EDITABLE) return b = a, Blockly.ASTNode.createFieldNode(b);
    return null
};
Blockly.ASTNode.prototype.findNextForInput_ = function () {
    ...
    for (var c; c = b.inputList[a]; a++) {
        for (var d = c.fieldRow, e = 0, f; f = d[e]; e++) if (f.EDITABLE) return Blockly.ASTNode.createFieldNode(f);
...
Blockly.ASTNode.prototype.findPrevForInput_ = function () {
    for (var a = this.location_.getParentInput(), b = a.getSourceBlock(), c = b.inputList.indexOf(a), d; d = b.inputList[c]; c--) {
        ...
        d = d.fieldRow;
        for (var e = d.length - 1, f; f = d[e]; e--) if (f.EDITABLE) return Blockly.ASTNode.createFieldNode(f)
    }
    return null
};
...
Blockly.user.keyMap.createSerializedKey = function (a, b) {
    for (var c = "", d = Blockly.utils.object.values(Blockly.user.keyMap.modifierKeys), e = 0, f; f = b[e]; e++) if (-1 < d.indexOf(f)) c += f; else throw Error(f + " is not a valid modifier key.");
    return c + a
};
...
Blockly.navigation.focusToolbox_ = function () {
    var a = Blockly.getMainWorkspace(), b = a.getToolbox();
...
Blockly.navigation.focusWorkspace_ = function () {
    Blockly.hideChaff();
    var a = Blockly.getMainWorkspace(), b = a.getCursor(), c = !!a.getToolbox(), d = a.getTopBlocks(!0);
...
Blockly.navigation.getFlyoutCursor_ = function () {
    var a = Blockly.getMainWorkspace(), b = null;
...
Blockly.navigation.disconnectBlocks_ = function () {
    var a = Blockly.getMainWorkspace(), b = a.getCursor().getCurNode();
    if (b.isConnection()) {
        var c = b.getLocation();
...
Blockly.navigation.onBlocklyAction = function (a) {
    var b = Blockly.getMainWorkspace().options.readOnly, c = !1;
...
Blockly.navigation.handleEnterForWS_ = function () {
    var a = Blockly.getMainWorkspace().getCursor().getCurNode(), b = a.getType();
...
Blockly.onKeyDown_ = function (a) {
    ...
    if (!(Blockly.utils.isTargetInput(a) || b.rendered && !b.isVisible())) if (b.options.readOnly) Blockly.navigation.onKeyPress(a); else {
        var c = !1;
...
Blockly.tree.BaseNode.prototype.initAccessibility = function () {
    ...
    if (a) {
        ...
        if (b = this.getChildrenElement()) if (Blockly.utils.aria.setRole(b, Blockly.utils.aria.Role.GROUP), b.hasChildNodes()) for (Blockly.utils.aria.setState(a, Blockly.utils.aria.State.EXPANDED, !1), a = this.getChildCount(), b = 1; b <= a; b++) {
...
Blockly.tree.BaseNode.prototype.addChildAt = function (a, b) {
    ...
    if (e = this.getElement()) if (this.updateExpandIcon(), Blockly.utils.aria.setState(e, Blockly.utils.aria.State.EXPANDED, this.getExpanded()), this.getExpanded()) {
        e =
            this.getChildrenElement();
        a.getElement() || a.createDom();
        var f = a.getElement(), g = d && d.getElement();
        e.insertBefore(f, g);
...
Blockly.tree.BaseNode.prototype.toDom = function () {
    var a = this.getExpanded() && this.hasChildren(), b = document.createElement("div");
...
Blockly.FieldTextInput.prototype.widgetCreate_ = function () {
    var a = Blockly.WidgetDiv.DIV, b = document.createElement("input");
...
Blockly.FieldAngle.prototype.dropdownCreate_ = function () {
    ...
    }, null), b = Blockly.utils.dom.createSvgElement("circle", {
...
Blockly.FieldDropdown.prototype.renderSelectedImage_ = function (a) {
    ...
    var b = Blockly.utils.dom.getTextWidth(this.arrow_), c = Number(a.width);
...
Blockly.FieldMultilineInput.prototype.widgetCreate_ = function () {
    var a = Blockly.WidgetDiv.DIV, b = this.workspace_.scale, c = document.createElement("textarea");
...
Blockly.FieldNumber.prototype.setPrecisionInternal_ = function (a) {
    ...
    var b = this.precision_.toString(), c = b.indexOf(".");
...
Blockly.CursorSvg.prototype.createDom = function () {
    this.svgGroup_ = Blockly.utils.dom.createSvgElement("g", {"class": this.isMarker_ ? Blockly.CursorSvg.MARKER_CLASS : Blockly.CursorSvg.CURSOR_CLASS}, null);
...
Blockly.CursorSvg.prototype.showWithBlockPrevOutput_ = function (a) {
    if (a) {
        var b = a.width, c = a.height, d = c * Blockly.CursorSvg.HEIGHT_MULTIPLIER, e = Blockly.CursorSvg.BLOCK_PADDING;
...
Blockly.CursorSvg.prototype.showWithStack_ = function (a) {
    a = a.getLocation();
    var b = a.getHeightWidth(), c = b.width + Blockly.CursorSvg.STACK_PADDING;
    b = b.height + Blockly.CursorSvg.STACK_PADDING;
    var d = -1 * Blockly.CursorSvg.STACK_PADDING / 2, e = -1 * Blockly.CursorSvg.STACK_PADDING / 2, f = d;
...
Blockly.CursorSvg.prototype.createCursorSvg_ = function () {
    ...
    this.cursorBlock_ = Blockly.utils.dom.createSvgElement("path", {
        width: Blockly.CursorSvg.CURSOR_WIDTH, height: Blockly.CursorSvg.CURSOR_HEIGHT, transform: "",
        style: "display: none;", fill: "none", stroke: a, "stroke-width": "4"
    }, this.cursorSvg_);
...
Blockly.blockRendering.ConstantProvider.prototype.makePuzzleTab = function () {
    function a(a) {
        a = a ? -1 : 1;
        var d = -a, e = c / 2, f = e + 2.5, l = e + .5, m = Blockly.utils.svgPaths.point(-b, a * e);
...
Blockly.blockRendering.ConstantProvider.prototype.makeInsideCorners = function () {
    var a = this.CORNER_RADIUS, b = Blockly.utils.svgPaths.arc("a", "0 0,0", a, Blockly.utils.svgPaths.point(-a, a)),
...
Blockly.blockRendering.RenderInfo.prototype.createRows_ = function () {
    ...
    var a = new Blockly.blockRendering.InputRow(this.constants_), b = this.block_.getIcons();
...
Blockly.geras.HighlightConstantProvider.prototype.makePuzzleTab = function () {
    ...
    return {
        width: a, height: b, pathUp: function (a) {
            return a ? c : e
        }, pathDown: function (a) {
            return a ? d : f
        }
...
Blockly.geras.HighlightConstantProvider.prototype.makeJaggedTeeth = function () {
    return {pathLeft: Blockly.utils.svgPaths.lineTo(5.1, 2.6) + Blockly.utils.svgPaths.moveBy(-10.2, 6.8) + Blockly.utils.svgPaths.lineTo(5.1, 2.6)}
};
...
Blockly.Trashcan.prototype.createDom = function () {
    ...
    var c = Blockly.utils.dom.createSvgElement("image", {
        width: Blockly.SPRITE.width, x: -this.SPRITE_LEFT_, height: Blockly.SPRITE.height,
        y: -this.SPRITE_TOP_, "clip-path": "url(#blocklyTrashBodyClipPath" + a + ")"
    }, this.svgGroup_);
    ...
    this.svgLid_ = Blockly.utils.dom.createSvgElement("image", {
        width: Blockly.SPRITE.width, x: -this.SPRITE_LEFT_, height: Blockly.SPRITE.height,
        y: -this.SPRITE_TOP_, "clip-path": "url(#blocklyTrashLidClipPath" + a + ")"
    }, this.svgGroup_);
...
Blockly.Themes.Dark.defaultBlockStyles = {
    ...
    procedure_blocks: {
        ...
        colourSecondary: "#d6bddb", colourTertiary: "#7a4984"
    },
